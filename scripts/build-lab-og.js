...
const LABS = [
  ...
  {
    key: "oracles",
    eyebrow: "ML × Blockchain · Verifiable inference",
    icon: "🔮",
    title: "ML Oracles",
  ...
  {
    key: "wm-compare",
    eyebrow: "ML security · Watermarking",
    icon: "⚖️",
  ...
  },
  {
    ...
    sub: "Consensus that trains, not hashes.",
    tagline: "PoL consensus, incentive contracts, and what the prototypes measured",
