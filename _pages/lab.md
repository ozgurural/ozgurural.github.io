...
<section class="lab-card lab-experiment" id="lab-tmr">
  ...
  <p class="lab-card__lead">
    To mathematically veto the universe's entropy, engineers invoke <strong>Triple Modular Redundancy</strong>. Three entirely isolated computers calculate the exact same kinematics in parallel, while a brutally simple hardware voter takes the majority result. The math is a masterpiece of cubic probability suppression: the chance of a system failure drops from a terrifying $q$ to an invisible $3q^2 - 2q^3$. It is a mathematical forcefield against the chaotic cosmos.
  </p>
  <p class="lab-card__lead">
