...
<section class="lab-card lab-experiment" id="lab-lvd" style="margin-top: 0;">
  ...
  <div class="lab-card__usecase">
    ...
    <span>Transport-delay and qualification limits are public: <a href="https://www.ecfr.gov/current/title-14/chapter-I/subchapter-D/part-60">FAA 14 CFR Part 60</a>, the equivalent EASA CS-FSTD(A), and for new devices EASA <a href="https://www.easa.europa.eu/en/document-library/certification-specifications/cs-fstd-issue-1">CS-FSTD Issue 1</a> (2026). The engineering discipline is drawn from the author's work on Level D full-flight-simulator systems at Avion, including the live monitoring layer around those simulators. No employer design is disclosed; the topology shown is the generic multi-host layout common to every Level D device. A companion design study, <a href="/lab/determinism/">AI Meets the Deadline</a>, asks what changes when an AI planner sits above a loop like this one.</span>
  </div>
