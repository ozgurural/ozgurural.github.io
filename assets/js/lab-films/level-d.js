/* =============================================================================
   level-d.js — cinematic explainer: what "hard real time" costs in a
...
(function () {
  ...
  function lower(s, html, at, o) {
    s.audio("level-d_" + _lowerCount++, at);
    o = o || {};
    flushLower(s, at);
  ...
  function build() {
    var film = window.LabAnim.create("#lvd-film", { width: 960, height: 540 });
    sceneContract(film);
    sceneTail(film);
  ...
  function appendix() {
    var host = document.querySelector('[data-role="lvd-appendix"]');
